(async () => {
    ...
    window.AudioStream = {
      init: async (bufSize, waitingBufSize, channels, sampleRate) => {
        ...
        await audioCtx.resume(); // for Safari: https://qiita.com/okaxaki/items/c807bdfe3e96d6ef7960
        ...
        console.log(`mp-audio-stream initialized. sampleRate:${audioCtx.sampleRate}`);
      },
